...
import 'package:test_case_ayo/utils/extension.dart';
import 'package:test_case_ayo/utils/router.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [BlocProvider(create: (context) => LeaderboardCubit())],
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          textTheme: const TextTheme(
            bodyLarge: TextStyle(fontSize: 16.0, color: ColorUI.BLACK),
          ...
          useMaterial3: true,
          dialogTheme: DialogThemeData(barrierColor: ColorUI.OVERLAY),
          bottomSheetTheme: BottomSheetThemeData(
            modalBarrierColor: ColorUI.OVERLAY,
          ),
        ),
        ...
        builder: (context, child) {
          ...
          final framedChild = MediaQuery(
            ...
            child: Padding(
              ...
              // Your gradient background stays outside in the parent DecoratedBox
              child: Align(
                alignment: Alignment.topCenter,
                // Ensure child can't grow beyond phone width
